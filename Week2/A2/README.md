...
Data have missing value because sensor sometime not work or broken. This need fix before do analysis.

**What it do:**
- Check how many missing value in each column using `isnull().sum()`
- Replace missing **number** value using **mean** of that column: this is better than delete to keep more data
...
Filter data to look at one specific station and compare all station.
...
- But it can see from line chart that winter (cold temperature) have higher pollution than summer
